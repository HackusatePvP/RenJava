 ...
 * <p>
 * Classes that implement the {@code PersistentData} interface can have their data saved and loaded using the saving feature of the RenJava visual novel framework.
